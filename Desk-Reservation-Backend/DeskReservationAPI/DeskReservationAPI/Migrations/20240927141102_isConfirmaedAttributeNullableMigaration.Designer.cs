...
namespace DeskReservationAPI.Migrations
{
    ...
    [Migration("20240927141102_isConfirmaedAttributeNullableMigaration")]
    partial class isConfirmaedAttributeNullableMigaration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DeskReservationAPI.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = new Guid("54a31ae5-b075-4fe1-8426-7d3d5e1e2d89"),
                            Department = "dep",
                        ...
                        new
                        {
                            UserID = new Guid("2595a9ad-3d0f-484c-aadd-353e2c6ff942"),
                            Department = "dep",
