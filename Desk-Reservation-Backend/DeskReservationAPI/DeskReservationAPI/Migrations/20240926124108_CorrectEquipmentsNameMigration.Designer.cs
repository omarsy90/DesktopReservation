...
namespace DeskReservationAPI.Migrations
{
    ...
    [Migration("20240926124108_CorrectEquipmentsNameMigration")]
    partial class CorrectEquipmentsNameMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DeskReservationAPI.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserID = new Guid("d76bfe06-8fa3-4670-90cf-5e1be6df6ad7"),
                            Department = "dep",
                        ...
                        new
                        {
                            UserID = new Guid("8b1ceeed-d505-4f1e-9631-64063abc5fd7"),
                            Department = "dep",
