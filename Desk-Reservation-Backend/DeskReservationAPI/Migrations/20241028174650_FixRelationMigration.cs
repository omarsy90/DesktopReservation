...
{
    /// <inheritdoc />
    public partial class FixRelationMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "66AFEF1E-0253-45F4-9968-6072073AD6C6", "dep", "admin@gmail.com", "admin", "admin", "ImurlGyyIPEa3+UpWmpkx3cHpNkG2U4JgJ6x6QtQjDA=", 2 },
                    { "86C4C6C0-A30F-4595-968D-3EF3E09E9F6D", "dep", "user2@gmail.com", "user2", "user2", "MtBDli4jZtpNRe4EYPmhzZZ8IfoCBCr3idMQMd4fZFU=", 1 },
                    { "B490AD07-7670-4B7B-8B78-E0176FA9EC4A", "dep", "user@gmail.com", "user", "user", "Wdhsa4sV38jU1gQf0nhLBxR3VoUjI8pcOxJHm+iImCc=", 1 }
                });

            migrationBuilder.InsertData(
                table: "Reservation",
                columns: new[] { "ReservationID", "DateEnd", "DateStart", "DeskID", "IsConfirmed", "ReservationType", "UserID", "isFavourited" },
                values: new object[,]
                {
                    { 1, new DateTime(2024, 12, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, true, "fix", "B490AD07-7670-4B7B-8B78-E0176FA9EC4A", false },
                    { 2, new DateTime(2023, 12, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, true, "fix", "B490AD07-7670-4B7B-8B78-E0176FA9EC4A", false },
                    { 3, new DateTime(2024, 5, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, null, "fix", "86C4C6C0-A30F-4595-968D-3EF3E09E9F6D", false }
                });

            migrationBuilder.InsertData(
                table: "Reservation",
                columns: new[] { "ReservationID", "DateEnd", "DateStart", "DeskID", "ReservationType", "UserID", "isFavourited" },
                values: new object[,]
                {
                    { 4, new DateTime(2024, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "flex", "B490AD07-7670-4B7B-8B78-E0176FA9EC4A", false },
                    { 5, new DateTime(2024, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 4, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "flex", "86C4C6C0-A30F-4595-968D-3EF3E09E9F6D", false },
                    { 6, new DateTime(2024, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "flex", "86C4C6C0-A30F-4595-968D-3EF3E09E9F6D", false }
                });

            migrationBuilder.InsertData(
                table: "Reservation",
                columns: new[] { "ReservationID", "DateEnd", "DateStart", "DeskID", "IsConfirmed", "ReservationType", "UserID", "isFavourited" },
                values: new object[] { 7, new DateTime(2025, 2, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, null, "fix", "86C4C6C0-A30F-4595-968D-3EF3E09E9F6D", false });
