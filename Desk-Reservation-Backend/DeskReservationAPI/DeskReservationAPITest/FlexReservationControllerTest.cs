...
namespace DeskReservationAPITest
{
    public class FlexReservationControllerTest :IClassFixture<TestingWebAppFactory<Program>>
    {
        ...
        [Fact]
        public async Task CreateFlexReservation_UnvalidReservationModel_RetuenbadRequest()
        {
            //Arrange
        ...
        [Fact]
        public async Task CreateFlexReservation_DeskAlreadyBookedIntimeRequested_ReturnBadRequest()
        {
        ...
        [Fact]
        public async Task CreateFlexReservation_DesknotFound_RteuenNotFound()
        {
        ...
        [Fact]
        public async Task CreateFlexReservation_ValidReservationModel_ReturnOk()
        {
        ...
        public async Task DeleteFlexReservation_CancellingTimeWhenReservationActive_ReturnBadRequest()
        {
            ...
            { DeskID=4 ,DtStart=DateTime.Now.AddDays(-1),
        ...
        private async Task<HttpResponseMessage> CreateFlexReservation(string token , ReservationModel reservationModel )
        {
